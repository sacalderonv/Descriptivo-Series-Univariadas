...
De las series con estacionalidad, usar el operador diferencia estacional y proceder a eliminar la componente estacional usando la función diff(series,lag=s,differences=D).
